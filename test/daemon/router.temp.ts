...
describe("Testing Router", () => {
  it("Should test basic functionality", (done) => {
    ...
    router
      .handleAdd(
        { params: { path: "foo", value: 1 }, id: "", method: "add" },
        mockPeer
      )
      .then(() =>
        router.handleAdd(
          { params: { path: "foo2", value: 2 }, id: "", method: "add" },
          mockPeer
        )
      )
      ...
      .then(() =>
        router.handleFetch(
          {
            params: { path: { startsWith: "f" }, id: "__f", sort: {} },
            id: "",
            method: "fetch",
          },
          mockPeer
      ...
      .then(() =>
        router.handleGet({
          params: { path: { startsWith: "f" }, sort: {}, id: "" },
          id: "",
          method: "get",
        })
      )
      ...
      .then(() =>
        router.forward("foo3", {
          params: { path: "foo3", value: 4 },
          id: "",
          method: "set",
        } as SetRequest)
      )
      .catch(() =>
        router.handleUnfetch({
          params: { id: "__f" },
          id: "",
          method: "unfetch",
        })
      ...
      .then(() =>
        router.handleAdd(
          { params: { path: "foo4" }, id: "", method: "add" },
          mockPeer
        )
      )
  ...
  it("Should test invalid subscription", (done) => {
    ...
    const router = new Router(DaemonMock());
    router
      .handleAdd(AddState("foo", 1), mockPeer)
      .then(() =>
        router.handleFetch(
          {
            params: { path: { startsWith: "f" }, id: "__f", sort: {} },
      ...
      .then(() => {
        mockPeer.publish = jest.fn().mockReturnValue(Promise.reject());
      })
      .then(() =>
        router.handleChange({
          params: { path: "foo", value: 4 },
