;(function () {
  ...
  types.operators = ['greaterThan', 'lessThan', 'equals', 'equalsNot', 'isType']
  ...
  ;(function (exports) {
    Object.defineProperty(exports, '__esModule', { value: true })
    exports.createTypedError =
      exports.FetchOnly =
      exports.Occupied =
      exports.PeerTimeout =
      exports.InvalidArgument =
      exports.NotFound =
      exports.ConnectionInUse =
      exports.ConnectionClosed =
  ...
  const generators = {
    equals: (field, other) => (x) =>
      (0, utils_1$1.getValue)(x, field) === other,
    ...
    isType: (field, other) => (x) =>
      typeof (0, utils_1$1.getValue)(x, field) === other
  }
  ...
  const castMessage = (msg) => {
    if (!('id' in msg)) throw new errors_1$3.DaemonError('No id')
    if (!('method' in msg)) throw new errors_1$3.DaemonError('No method')
    // console.log(msg);
  ...
  class JsonRPC extends events_1$8.default {
    ...
    _handleMessage = (event) => {
      ...
      try {
        ...
        this.respond(
          '',
          (0, errors_1$2.invalidRequest)('Invalid format'),
          false
        )
    ...
    _dispatchRequest = (message) => {
      if (this.listenerCount(message.method) === 0) {
        ...
        this.respond(
          message.id,
          (0, errors_1$2.methodNotFound)(message.method),
          false
        )
      } else {
  ...
  ;(function (module) {
    !(function () {
        ...
        if (d2 < ε2) {
          ...
          i = function (t) {
            var s = t * S,
              coshr0 = d3_cosh(r0),
              u =
                (w0 / (ρ2 * d1)) * (coshr0 * d3_tanh(ρ * s + r0) - d3_sinh(r0))
            return [
              ux0 + u * dx,
              uy0 + u * dy,
          ...
          function format(date) {
            ...
            while (++i < n) {
              if (template.charCodeAt(i) === 37) {
                ...
                if (
                  (p = d3_time_formatPads[(c = template.charAt(++i))]) != null
                )
                  c = template.charAt(++i)
          ...
          for (i = 0; i < m; ++i) {
            ...
            if ((l = x * x + y * y)) {
              ...
              t.x -=
                x *
                (k =
                  s.weight + t.weight ? s.weight / (s.weight + t.weight) : 0.5)
              t.y -= y * k
              s.x += x * (k = 1 - k)
              s.y += y * k
            }
            ...
            if (x3 != null) {
              ...
              if (rc === rc0) {
                path.push(
                  ...
                  ' 0 ',
                  cw ^
                    d3_svg_arcSweep(t21[1][0], t21[1][1], t03[1][0], t03[1][1]),
                  ',',
                  1 - cw,
                  ' ',
                  t03[1],
      ...
      if (module.exports) module.exports = d3
      else this.d3 = d3
    })()
  })(d3$1)
