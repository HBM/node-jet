(function () {
	...
	(function (exports) {
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.createTypedError = exports.FetchOnly = exports.Occupied = exports.PeerTimeout = exports.InvalidArgument = exports.NotFound = exports.ConnectionInUse = exports.ConnectionClosed = exports.Unauthorized = exports.InvalidPassword = exports.InvalidUser = exports.PeerError = exports.DaemonError = exports.BaseError = exports.responseTimeout = exports.invalidRequest = exports.methodNotFound = exports.invalidParams = exports.METHOD_NOT_FOUND = exports.INVALID_REQUEST = exports.RESPONSE_TIMEOUT_CODE = exports.INTERNAL_ERROR_CODE = exports.INVALID_PARAMS_CODE = void 0;
		...
		const invalidParams = (data) => {
		    return {
		        ...
		        code: exports.INVALID_PARAMS_CODE,
		        data: data,
		    };
		};
		exports.invalidParams = invalidParams;
		const methodNotFound = (data) => ({
		    message: "Method not found",
		    code: exports.METHOD_NOT_FOUND,
		    data: data,
		});
		exports.methodNotFound = methodNotFound;
		const invalidRequest = (data) => ({
		    message: "Invalid Request",
		    code: exports.INVALID_REQUEST,
		    data: data,
		});
		exports.invalidRequest = invalidRequest;
		const responseTimeout = (data) => ({
		    message: "Response Timeout",
		    code: exports.RESPONSE_TIMEOUT_CODE,
		    data: data,
		});
		...
		class BaseError extends Error {
		    url = "";
		    constructor(name, message, strStack = "no remote stack") {
		        super(message);
		        this.name = "jet." + name;
		 ...
		 *
		 */
		class ConnectionClosed extends BaseError {
		    constructor(err) {
		 ...
		 *
		 */
		class ConnectionInUse extends BaseError {
		    constructor(err) {
		...
		class InvalidArgument extends BaseError {
		    constructor(msg) {
		        super("InvalidArgument", msg || "The provided argument(s) have been refused by the State/Method");
		    }
		}
		 ...
		 *
		 */
		class PeerTimeout extends BaseError {
		    constructor() {
		        super("PeerTimeout", "The peer processing the request did not respond within the specified timeout");
		    }
		}
		 ...
		 *
		 */
		class Occupied extends BaseError {
		    constructor() {
		        super("Occupied", "A State/Method with the same path has already been added");
		    }
		}
		 ...
		 *
		 */
		class FetchOnly extends BaseError {
		    constructor() {
		        super("FetchOnly", "The State cannot be modified");
		    }
		}
		exports.FetchOnly = FetchOnly;
		const createTypedError = (jsonrpcError) => {
		    const code = jsonrpcError.code;
		    if (code === exports.INVALID_PARAMS_CODE) {
		    ...
		    else if (code === exports.RESPONSE_TIMEOUT_CODE) {
		        return new PeerTimeout();
		    }
		    else if (code === exports.INTERNAL_ERROR_CODE) {
		        const data = jsonrpcError.data;
	...
	const errorObject = (err) => {
	    ...
	    if (typeof err === "object" && err.code && err.message) {
	        ...
	        if (err instanceof errors_1$5.InvalidArgument) {
	            return (0, errors_1$5.invalidParams)({
	                invalidArgument: err,
	            });
	        }
	        else {
	...
	const generatePredicate = (field, rule) => {
	    ...
	    if (!gen) {
	        throw (0, errors_1$4.invalidParams)("unknown generator " + rule.operator);
	    }
	    else {
	...
	class Subscription {
	    ...
	    addRoute = (route) => {
	        ...
	        route.addListener("Change", (value) => this.enqueue({ path: route.path, event: "Change", value }));
	...
	route.Route = void 0;
	const events_1$a = __importDefault$b(require$$0$1);
	class Route extends events_1$a.default {
	    owner;
	    value;
	    path;
	...
	const castMessage = (msg) => {
	    if (!("id" in msg))
	        throw new errors_1$3.DaemonError("No id");
	    if (!("method" in msg))
	        throw new errors_1$3.DaemonError("No method");
	    // console.log(msg);
	    ...
	    switch (method) {
	        ...
	        case "configure":
	            if (!params || !("name" in params))
	                throw (0, errors_1$3.invalidParams)("Only params.name supported");
	            return msg;
	        case "unfetch":
	            if (!params || !("id" in params))
	                throw (0, errors_1$3.invalidParams)("Fetch id required");
	            return msg;
	        default:
	            if (!params || !("path" in params))
	                throw (0, errors_1$3.invalidParams)("Path required");
	    }
	    switch (method) {
	        case "fetch":
	            if (!("id" in params))
	        ...
	        case "set":
	            if (!("value" in params))
	                throw (0, errors_1$3.invalidParams)("Value required");
	            return msg;
	        default:
	            return msg;
	    }
	...
	const events_1$9 = __importDefault$a(require$$0$1);
	const net_1$1 = require$$1;
	class MessageSocket extends events_1$9.default {
	    last = Buffer.alloc(0);
	    len = -1;
	    socket;
	    constructor(port, ip = "") {
	    ...
	    addEventListener = (method, listener) => {
	        const onMessage = (data, flags) => {
	            listener.call(this, new MessageEvent(data, flags && flags.binary ? "Binary" : "Text", this));
	        };
	...
	(function (exports) {
		...
		Object.defineProperty(exports, "__esModule", { value: true });
		exports.netImpl = exports.Socket = exports.WebSocketImpl = exports.isBrowser = exports.isNodeJs = void 0;
		const ws_1 = require$$2;
		const net_1 = __importDefault(require$$1);
		exports.isNodeJs = typeof window === "undefined";
		exports.isBrowser = typeof window !== "undefined";
		exports.WebSocketImpl = exports.isNodeJs ? ws_1.WebSocket : WebSocket;
		exports.Socket = exports.isNodeJs ? net_1.default.Socket : { on: () => { } };
		exports.netImpl = exports.isNodeJs
		    ? net_1.default
		    : {
		        Socket: () => { },
		        createServer: function () { },
		        connect: (_port, _ip) => exports.Socket,
		    };
	} (_1_socket));
	...
	const ws_1$1 = require$$2;
	const message_socket_1$1 = __importDefault$9(messageSocket);
	...
	const events_1$8 = __importDefault$8(require$$0$1);
	 ...
	 * @private
	 */
	class JsonRPC extends events_1$8.default {
	    sock;
	    config;
	    messages = [];
	    willFlush = false;
	    ...
	    _handleMessage = (event) => {
	        ...
	        try {
	            ...
	            this.respond("", (0, errors_1$2.invalidRequest)("Invalid format"), false);
	    ...
	    _dispatchResponse = (message) => {
	        ...
	        if (isErrorMessage(message)) {
	            const err = typeof message.error === "string"
	                ? message.error
	                : (0, errors_1$2.createTypedError)(message.error);
	    ...
	    _dispatchRequest = (message) => {
	        if (this.listenerCount(message.method) === 0) {
	            ...
	            this.respond(message.id, (0, errors_1$2.methodNotFound)(message.method), false);
	        }
	        else {
	     ...
	     * Queue.
	     */
	    queue = (message) => this.messages.push(message);
	    /**
	     * Flush.
	     */
	    flush = () => {
	    ...
	    send = (method, params) => {
	        return new Promise((resolve, reject) => {
	            if (!this._isOpen) {
	                reject(new errors_1$2.ConnectionClosed("Connection is closed"));
	            }
	            else {
	    ...
	    notify = (fetchId, params) => {
	        return new Promise((resolve, reject) => {
	            if (!this._isOpen) {
	                ...
	                resolve({}); //Publish messages are not acknowledged
	            }
	        });
	    };
	    /**
	...
	const events_1$7 = __importDefault$7(require$$0$1);
	const net_1 = require$$1;
	const message_socket_1 = __importDefault$7(messageSocket);
	const socket_1$1 = socket;
	class TCPServer extends events_1$7.default {
	    config;
	    tcpServer;
	    connectionId = 1;
	    constructor(config) {
	    ...
	    listen = () => {
	        this.tcpServer = (0, net_1.createServer)((peerSocket) => {
	            ...
	            const sock = new socket_1$1.Socket();
	            sock.addNativeSocket(new message_socket_1.default(peerSocket));
	...
	const events_1$6 = __importDefault$6(require$$0$1);
	const _1$1 = _1_socket;
	const ws_1 = require$$2;
	const socket_1 = socket;
	class WebsocketServer extends events_1$6.default {
	    config;
	    wsServer;
	    connectionId = 1;
	    constructor(config) {
	    ...
	    listen = () => {
	        ...
	        this.wsServer.on("connection", (ws, _req) => {
	            const sock = new socket_1.Socket();
	...
	const events_1$5 = __importDefault$5(require$$0$1);
	const _1 = __importDefault$5(_2_jsonrpc);
	const tcpserver_1 = tcpserver;
	const wsserver_1 = wsserver;
	class JsonRPCServer extends events_1$5.default {
	    config;
	    tcpServer;
	    wsServer;
	    connections = {};
	    ...
	    listen = () => {
	        if (this.config.tcpPort) {
	            ...
	            this.tcpServer.addListener("connection", (sock) => {
	                const jsonRpc = new _1.default(this.log, {}, sock);
	...
	Object.defineProperty(daemon, "__esModule", { value: true });
	daemon.Daemon = void 0;
	const events_1$4 = __importDefault$4(require$$0$1);
	const log_1$1 = log;
	...
	class Daemon extends events_1$4.default {
	    users;
	    infoObject;
	    log;
	    jsonRPCServer;
	    ...
	    */
	    add = (peer, id, params) => {
	        ...
	        if (path in this.routes) {
	            peer.respond(id, new errors_1$1.Occupied(), false);
	            return;
	        }
	    ...
	    */
	    change = (peer, id, msg) => {
	        if (msg.path in this.routes) {
	            ...
	            peer.respond(id, new errors_1$1.NotFound(), false);
	        }
	    };
	    /*
	    ...
	    */
	    fetch = (peer, id, msg) => {
	        if (this.simpleFetch() &&
	            ...
	            peer.respond(id, { error: "Only one fetcher per peer in simple fetch Mode" }, false);
	        }
	        const sub = new subscription_1$1.Subscription(msg, peer);
	        this.addListener("notify", sub.send);
	        this.subscriber.push(sub);
	        sub.setRoutes(Object.values(this.routes).filter((route) => this.routes[route.path].value && //check if state
	    ...
	    */
	    forward = (method, params) => this.routes[params.path].owner.send(method, params);
	    /*
	    Info requests: Info requests are always synchronous
	    */
	    info = (peer, id, _params) => {
	        peer.respond(id, this.infoObject, true);
	    };
	    configure = (peer, id, _params) => {
	        peer.respond(id, {}, true);
	    };
	    /**
	     * Connection event.
	    ...
	    listen = (listenOptions = defaultListenOptions) => {
	        this.jsonRPCServer = new server_1.JsonRPCServer(this.log, listenOptions);
	        this.jsonRPCServer.addListener("connection", (newPeer) => {
	            ...
	            newPeer.addListener("set", (_peer, id, params) => this.forward("set", params).then((res) => newPeer.respond(id, res, true)));
	            newPeer.addListener("call", (_peer, id, params) => this.forward("call", params).then((res) => newPeer.respond(id, res, true)));
	        });
	        this.jsonRPCServer.addListener("disconnect", (peer) => {
	            ...
	            this.subscriber = this.subscriber.filter((fetcher) => fetcher.owner === peer);
	        });
	...
	const events_1$3 = __importDefault$3(require$$0$1);
	const subscription_1 = subscription;
	class Fetcher extends events_1$3.default {
	    message = { path: {}, value: {}, sort: {}, id: "" };
	    valueRules = {};
	    constructor() {
	        super();
	    }
	    ...
	    matches = (path, value) => {
	        const sub = new subscription_1.Subscription(this.message);
	        console.log(path, this.message, sub.matchesPath(path), sub.matchesValue(value));
	...
	peer$1.Peer = void 0;
	const types_1 = types;
	const _2_jsonrpc_1 = __importDefault$2(_2_jsonrpc);
	const events_1$2 = __importDefault$2(require$$0$1);
	const fetcher_1 = __importDefault$2(fetcher);
	const log_1 = log;
	const utils_1 = utils;
	 ...
	 */
	class Peer extends events_1$2.default {
	    #fetchId = 1;
	    #config;
	    #jsonrpc;
	    ...
	    constructor(config, sock) {
	        ...
	        this.#jsonrpc.addListener("get", (_peer, id, m) => {
	            ...
	            if (state) {
	                ...
	                this.#jsonrpc.respond(id, new errors_1.NotFound(), false);
	            }
	        });
	    ...
	    unfetch = (fetcher) => {
	        ...
	        if (!this.fetchFull()) {
	            ...
	            if (Object.keys(this.#fetcher).length === 1) {
	                return this.#jsonrpc.send("unfetch", { id: types_1.fetchSimpleId });
	            }
	            else {
	                return Promise.resolve({});
	            }
	            ...
	            return this.#jsonrpc.send("unfetch", { id: id }).then((res) => {
	                delete this.#fetcher[id];
	    ...
	    fetch = (fetcher) => {
	        ...
	        if (!(types_1.fetchSimpleId in this.#fetcher)) {
	            ...
	            return this.#jsonrpc.send("fetch", {
	                id: types_1.fetchSimpleId,
	                path: { startsWith: "" },
	            });
	        }
	        else {
	     ...
	     *
	     */
	    batch = (action) => this.#jsonrpc.batch(action);
	    /**
	     ...
	     * @returns {external:Promise}
	     */
	    get = (expression) => this.#jsonrpc.send("get", expression);
	    /**
	     ...
	     */
	    remove = (stateOrMethod) => this.#jsonrpc.send("remove", { path: stateOrMethod.path() });
	    /**
	     ...
	     * @private
	     */
	    configure = (params) => this.#jsonrpc.send("config", params);
	    /**
	    ...
	    set = (path, value, options = {}) => {
	        ...
	        if (options.timeout)
	            params.timeout = options.timeout;
	        if (options.valueAsResult)
	            params.valueAsResult = options.valueAsResult;
	...
	state.State = void 0;
	const events_1$1 = __importDefault$1(require$$0$1);
	/**
	 ...
	 *
	 */
	class State extends events_1$1.default {
	    _path;
	    _value;
	    _access;
	    _readonly;
	    constructor(path, initialValue, readonly = false, access = null) {
	        super();
	        this._path = path;
