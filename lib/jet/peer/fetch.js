 ...
 */
var FakeFetcher = function (jsonrpc, fetchParams, f, fRef, callbacks) {
	...
	fetchParams.id = id;
	var fetchDispatcher = createFetchDispatcher(fetchParams, f, fRef);
 ...
 */
var Fetcher = function (jsonrpc, params, f, fRef, callbacks) {
	var id = '__f__' + fetchId;
	++fetchId;

	var fetchDispatcher = createFetchDispatcher(params, f, fRef);
