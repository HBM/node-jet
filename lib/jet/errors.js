 ...
 *
 */
const BaseError = function (name, message, stack) {
  ...
  const url = errorUrlBase + '#jet' + name.toLowerCase()
...
const DaemonError = function (msg) {
 ...
 *
 */
const ConnectionClosed = function (err) {
 ...
 *
 */
const InvalidArgument = function (msg) {
