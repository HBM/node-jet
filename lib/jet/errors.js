...
var BaseError = function (name, message, url, stack) {
	var tmp = Error.call(this, message);
	tmp.name = this.name = 'jet.' + name;
	this.message = tmp.message;
	this.url = tmp.url = url || 'http://github.com/lipp/blob/master/node-jet/doc/peer.md';
...
var PeerError = function (err) {
	BaseError.call(this, 'PeerError', err.message, undefined, err.stack);
};
