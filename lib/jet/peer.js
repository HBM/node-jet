 ...
 * ```
 *
 * @returns {Promise} A Promise which gets resolved once connected to the Daemon, or gets rejected with either:
 * 	- {ConnectionClosed}
 * 	- {InvalidUser}
 * 	- {InvalidPassword}
 *
 ...
 * @returns {Promise} Gets resolved as soon as the Daemon has registered the fetch expression.
 */
 ...
 * @returns {Promise} Gets resolved as soon as the Daemon has unregistered the fetch expression.
 *
 */
 ...
 * @returns {Promise} Gets resolved as soon as the content has been added to the Daemon.
 */
 ...
 * @returns {Promise} Gets resolved as soon as the content has been removed from the Daemon.
 */
